...
export interface RiskArea {
  ...
  factors: { label: Bilingual; weight: number }[];
...
export const RISK_AREAS: RiskArea[] = [
  {
    id: "ra-1",
    area: { en: "Gariahat market perimeter", bn: "গড়িয়াহাট বাজার এলাকা" },
    division: "South East",
    score: 76,
    trend: "rising",
    factors: [
      { label: { en: "Historical incident density", bn: "ঐতিহাসিক ঘটনার ঘনত্ব" }, weight: 38 },
      { label: { en: "Recent complaints", bn: "সাম্প্রতিক অভিযোগ" }, weight: 24 },
      { label: { en: "Traffic incidents", bn: "ট্রাফিক দুর্ঘটনা" }, weight: 18 },
      { label: { en: "Emergency calls", bn: "জরুরি কল" }, weight: 12 },
      { label: { en: "Other factors", bn: "অন্যান্য কারণ" }, weight: 8 },
    ],
    recommendation: { en: "Additional evening foot patrol between 18:00 and 21:00; review lighting on the east footpath.", bn: "সন্ধ্যা ১৮:০০ থেকে ২১:০০ পর্যন্ত অতিরিক্ত পায়ে টহল; পূর্ব ফুটপাতের আলো পর্যালোচনা।" },
    lat: 22.5183,
    lng: 88.366,
  },
  {
    id: "ra-2",
    area: { en: "Sealdah station approach", bn: "শিয়ালদহ স্টেশন প্রবেশপথ" },
    division: "East",
    score: 71,
    trend: "steady",
    factors: [
      { label: { en: "Historical incident density", bn: "ঐতিহাসিক ঘটনার ঘনত্ব" }, weight: 41 },
      { label: { en: "Footfall concentration", bn: "জনসমাগমের ঘনত্ব" }, weight: 27 },
      { label: { en: "Recent complaints", bn: "সাম্প্রতিক অভিযোগ" }, weight: 19 },
      { label: { en: "Other factors", bn: "অন্যান্য কারণ" }, weight: 13 },
    ],
    recommendation: { en: "Maintain current deployment; review CCTV coverage of the north gate.", bn: "বর্তমান মোতায়েন বজায় রাখুন; উত্তর গেটের সিসিটিভি কভারেজ পর্যালোচনা করুন।" },
    lat: 22.5674,
    lng: 88.3702,
  },
  {
    id: "ra-3",
    area: { en: "Behala Chowrasta junction", bn: "বেহালা চৌরাস্তা মোড়" },
    division: "South West",
    score: 64,
    trend: "rising",
    factors: [
      { label: { en: "Traffic incidents", bn: "ট্রাফিক দুর্ঘটনা" }, weight: 44 },
      { label: { en: "Emergency calls", bn: "জরুরি কল" }, weight: 22 },
      { label: { en: "Historical incident density", bn: "ঐতিহাসিক ঘটনার ঘনত্ব" }, weight: 21 },
      { label: { en: "Other factors", bn: "অন্যান্য কারণ" }, weight: 13 },
    ],
    recommendation: { en: "Traffic management intervention at peak hours; signal phase review.", bn: "ব্যস্ত সময়ে ট্রাফিক ব্যবস্থাপনায় হস্তক্ষেপ; সিগন্যাল পর্যায় পর্যালোচনা।" },
    lat: 22.4989,
    lng: 88.3103,
  },
  {
    id: "ra-4",
    area: { en: "Salt Lake Sector V night corridor", bn: "সল্টলেক সেক্টর ফাইভ রাত্রিকালীন করিডোর" },
    division: "Bidhannagar",
    score: 48,
    trend: "falling",
    factors: [
      { label: { en: "Recent complaints", bn: "সাম্প্রতিক অভিযোগ" }, weight: 34 },
      { label: { en: "Historical incident density", bn: "ঐতিহাসিক ঘটনার ঘনত্ব" }, weight: 30 },
      { label: { en: "Lighting deficiency reports", bn: "আলোর ঘাটতির অভিযোগ" }, weight: 24 },
      { label: { en: "Other factors", bn: "অন্যান্য কারণ" }, weight: 12 },
    ],
    recommendation: { en: "Continue the current lighting programme; reassess in 30 days.", bn: "বর্তমান আলোকসজ্জা কর্মসূচি চালিয়ে যান; ৩০ দিনে পুনর্মূল্যায়ন।" },
    lat: 22.5758,
    lng: 88.4337,
  },
];
