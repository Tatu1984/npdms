...
export const en = {
  ...
  force: {
    ...
    otherReferrals: "Referrals between departments",
  },

  referrals: {
    name: "Referrals",
    desc: "Records handed from one department to another, with the reason and the decision",
    lead: "A record crosses between departments only this way: someone proposes it with a reason, and the receiving department accepts or declines. Both halves are recorded against the record.",
    incoming: "Sent to you",
    outgoing: "Sent by you",
    incomingEmpty: "No department has referred a record to you.",
    outgoingEmpty: "You have not referred a record to another department.",
    awaitingYou: "{n} awaiting your decision",
    propose: "Refer a record",
    proposeTitle: "Refer a record to another department",
    proposeLead:
      "The receiving department sees the record once it accepts, and the referral stays on the record either way.",
    recordType: "Record",
    recordId: "Record reference",
    recordIdHelp: "The identifier of the case, FIR or complaint being referred.",
    toForce: "Refer to",
    reason: "Reason",
    reasonHelp: "Why this department should take the record. Recorded and shown to them.",
    authority: "Authority",
    authorityHelp: "The order or approval behind the referral, if there is one.",
    send: "Send referral",
    sent: "Referral sent",
    accept: "Accept",
    decline: "Decline",
    withdraw: "Withdraw",
    decideTitle: "{decision} referral {number}",
    note: "Note",
    noteHelp: "Optional. Shown to the department that referred it.",
    accepted: "Referral accepted",
    declined: "Referral declined",
    withdrawn: "Referral withdrawn",
    withdrawConfirm: "Withdraw referral {number}?",
    withdrawBody: "The receiving department will no longer see it awaiting a decision.",
    referredBy: "Referred by",
    decidedBy: "Decided by",
    needsSHO: "Referrals are proposed and decided by the Officer-in-Charge and above.",
